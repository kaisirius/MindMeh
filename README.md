...
#### Note: Project still in development phase
...
│   ├── .gitignore         
│   ├── package.json               # Metadata about nodeJS project 
│   ├── package-lock.json          
│   ├── tsconfig.json              # Typsecript compiler configurations
│   └── tsconfig.tsbuildinfo
├── frontend/
│    └── (your React / Next.js / Vite code here)
│   └── tsconfig.tsbuildinfo
└── README.md
